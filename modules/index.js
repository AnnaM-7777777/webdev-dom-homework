...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const {replyToComment} = setupForm(comments, commentsList, addFormName, addFormText, addFormButton); // Получаем replyToComment
